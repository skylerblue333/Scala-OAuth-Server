...
oauth server in Scala.

## 🚀 Overview
This repository contains a professional implementation of **Scala OAuth Server**. It is designed with clean code principles and focuses on functionality and reliability.
